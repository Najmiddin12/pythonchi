...
class StudentAdmin(admin.ModelAdmin):
    list_display = ("username", "last_name", "number", "address", "age", "edu_name", "about", "telegram", "linkedin", "github", "password")
...
@admin.register(Uyishi)
class UyishiAdmin(admin.ModelAdmin):
    list_display = ("homework", "comment_title", "comment_text", "homework_status", "comment_status", "student", "group", "modul", "hw")
